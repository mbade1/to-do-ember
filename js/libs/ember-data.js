(function (global) {
  ...
  define("activemodel-adapter/setup-container", [
    "ember-data/system/container_proxy",
    "activemodel-adapter/system/active_model_serializer",
    ...
    __exports__["default"] = function setupActiveModelAdapter(
      container,
      application
    ) {
  ...
  define("activemodel-adapter/system/active_model_serializer", [
    "ember-inflector",
    "ember-data/serializers/rest_serializer",
    "exports",
  ], function (__dependency1__, __dependency2__, __exports__) {
    "use strict";
  ...
  define("ember-data", [
    "ember-data/core",
    "ember-data/ext/date",
    "ember-data/system/promise_proxies",
    "ember-data/system/store",
    "ember-data/system/model",
    "ember-data/system/adapter",
    "ember-data/system/debug",
    "ember-data/system/record_arrays",
    "ember-data/system/record_array_manager",
    "ember-data/adapters",
    "ember-data/serializers/json_serializer",
    "ember-data/serializers/rest_serializer",
    "ember-inflector",
    "ember-data/serializers/embedded_records_mixin",
    "activemodel-adapter",
    "ember-data/transforms",
    "ember-data/system/relationships",
    "ember-data/ember-initializer",
    "ember-data/setup-container",
    "ember-data/system/container_proxy",
    "ember-data/system/relationships/relationship",
    "exports",
  ], function (
    __dependency1__,
    __dependency2__,
    ...
    var AdapterPopulatedRecordArray =
      __dependency8__.AdapterPopulatedRecordArray;
  ...
  define("ember-data/adapters", [
    "ember-data/adapters/fixture_adapter",
    "ember-data/adapters/rest_adapter",
    "exports",
  ], function (__dependency1__, __dependency2__, __exports__) {
    "use strict";
    /**
  ...
  define("ember-data/adapters/fixture_adapter", [
    ...
    __exports__["default"] = Adapter.extend({
      ...
      queryFixtures: function (fixtures, query, type) {
        Ember.assert(
          "Not implemented: You must override the DS.FixtureAdapter::queryFixtures method to support querying the fixture store."
        );
      },
      ...
      find: function (store, type, id) {
        ...
        Ember.assert(
          "Unable to find fixtures for model type " +
            type.toString() +
            ". If you're defining your fixtures using `Model.FIXTURES = ...`, please change it to `Model.reopenClass({ FIXTURES: ... })`.",
          fixtures
        );
      ...
      findMany: function (store, type, ids) {
        ...
        Ember.assert(
          "Unable to find fixtures for model type " + type.toString(),
          fixtures
        );
        ...
        return new Ember.RSVP.Promise(function (resolve, reject) {
          ...
          hash.error = function (jqXHR, textStatus, errorThrown) {
            Ember.run(
              null,
              reject,
              adapter.ajaxError(jqXHR, jqXHR.responseText)
            );
          };
  ...
  define("ember-data/initializers/data_adapter", [
    "ember-data/system/debug/debug_adapter",
    "exports",
  ], function (__dependency1__, __exports__) {
    "use strict";
  ...
  define("ember-data/initializers/store", [
    ...
    __exports__["default"] = function initializeStore(container, application) {
      ...
      container.register(
        "store:main",
        container.lookupFactory("store:application") ||
          (application && application.Store) ||
          Store
      );
  ...
  define("ember-data/initializers/store_injections", ["exports"], function (
    __exports__
  ) {
    "use strict";
    /**
  ...
  define("ember-data/serializers/embedded_records_mixin", [
    ...
    var EmbeddedRecordsMixin = Ember.Mixin.create({
      ...
      hasSerializeIdsOption: function (attr) {
        var option = this.attrsOption(attr);
        return (
          option && (option.serialize === "ids" || option.serialize === "id")
        );
      },
    ...
    function extractEmbeddedHasMany(store, key, embeddedType, hash) {
      ...
      forEach(hash[key], function (data) {
        var embeddedRecord = embeddedSerializer.normalize(
          embeddedType,
          data,
          null
        );
  ...
  define("ember-data/serializers/json_serializer", ["exports"], function (
    __exports__
  ) {
    "use strict";
    var get = Ember.get;
    ...
    __exports__["default"] = Ember.Object.extend({
      ...
      transformFor: function (attributeType, skipAssertion) {
        ...
        Ember.assert(
          "Unable to find transform for '" + attributeType + "'",
    ...
    var RESTSerializer = JSONSerializer.extend({
          ...
          forEach.call(
            ...
            function (hash) {
              ...
              var isFirstCreatedRecord =
                isPrimary && !recordId && !primaryRecord;
      ...
      serializePolymorphicType: function (record, json, relationship) {
        ...
        if (Ember.isNone(belongsTo)) {
          ...
          json[key + "Type"] = Ember.String.camelize(
            belongsTo.constructor.typeKey
          );
        }
      },
    });
  ...
  define("ember-data/setup-container", [
    "ember-data/initializers/store",
    "ember-data/initializers/transforms",
    "ember-data/initializers/store_injections",
    "ember-data/initializers/data_adapter",
    "activemodel-adapter/setup-container",
    "exports",
  ], function (
    __dependency1__,
    __dependency2__,
  ...
  define("ember-data/system/adapter", ["exports"], function (__exports__) {
    ...
    var Adapter = Ember.Object.extend({
      ...
      /**
          ...
          */
      serialize: function (record, options) {
        return get(record, "store")
          .serializerFor(record.constructor.typeKey)
  ...
  define("ember-data/system/container_proxy", ["exports"], function (
    __exports__
  ) {
    "use strict";
    /**
    ...
    ContainerProxy.prototype.registerAlias = function (
      source,
      dest,
      preLookup
    ) {
    ...
    ContainerProxy.prototype.registerDeprecation = function (
      deprecated,
      valid
    ) {
      var preLookupCallback = function () {
        Ember.deprecate(
          "You tried to look up '" +
            deprecated +
            "', " +
  ...
  define("ember-data/system/debug", [
    "ember-data/system/debug/debug_info",
    "ember-data/system/debug/debug_adapter",
    "exports",
  ], function (__dependency1__, __dependency2__, __exports__) {
    "use strict";
  ...
  define("ember-data/system/map", ["exports"], function (__exports__) {
    "use strict";
    /**
    ...
    if (usesOldBehavior) {
      ...
      MapWithDefault.prototype.__super$forEach =
        Ember.MapWithDefault.prototype.forEach;
  ...
  define("ember-data/system/model", [
    "ember-data/system/model/model",
    "ember-data/system/model/attributes",
    "ember-data/system/model/states",
    "ember-data/system/model/errors",
    "exports",
  ], function (
    __dependency1__,
    __dependency2__,
  ...
  define("ember-data/system/model/attributes", [
    ...
    function hasValue(record, key) {
      return (
        record._attributes.hasOwnProperty(key) ||
  ...
  define("ember-data/system/model/model", [
    ...
    var JSONSerializer;
    var retrieveFromCurrentState = Ember.computed("currentState", function (
      key,
      value
    ) {
    ...
    function splitOnDot(name) {
      return (
        _splitOnDotCache[name] || (_splitOnDotCache[name] = name.split("."))
      );
    }

    function extractPivotName(name) {
      return (
        _extractPivotNameCache[name] ||
    ...
    var Model = Ember.Object.extend(Ember.Evented, {
      ...
      _setup: function () {
        ...
        this.constructor.eachRelationship(function (key, descriptor) {
          model._relationships[key] = createRelationshipFor(
            model,
            descriptor,
            model.store
          );
      ...
      _preloadBelongsTo: function (key, preloadValue, type) {
        var recordToSet = this._convertStringOrNumberIntoRecord(
          preloadValue,
          type
        );
      ...
      materializeAttributes: function (attributes) {
        Ember.assert(
          "Must pass a hash of attributes to materializeAttributes",
          !!attributes
        );
      ...
      willMergeMixin: function (props) {
        Ember.assert(
          "`data` is a reserved property name on DS.Model objects. Please choose a different property name for " +
            this.constructor.toString(),
          !props.data
        );
      },
  ...
  define("ember-data/system/promise_proxies", ["exports"], function (
    __exports__
  ) {
    "use strict";
    var Promise = Ember.RSVP.Promise;
  ...
  define("ember-data/system/record_array_manager", [
    ...
    var AdapterPopulatedRecordArray =
      __dependency1__.AdapterPopulatedRecordArray;
  ...
  define("ember-data/system/record_arrays", [
    ...
    "ember-data/system/record_arrays/filtered_record_array",
    "ember-data/system/record_arrays/adapter_populated_record_array",
    "ember-data/system/record_arrays/many_array",
    "exports",
  ], function (
    __dependency1__,
    __dependency2__,
  ...
  define("ember-data/system/record_arrays/adapter_populated_record_array", [
    ...
    __exports__["default"] = RecordArray.extend({
      ...
      replace: function () {
        ...
        throw new Error(
          "The result of a server query (on " + type + ") is immutable."
        );
      },
  ...
  define("ember-data/system/record_arrays/filtered_record_array", [
    ...
    __exports__["default"] = RecordArray.extend({
      ...
      replace: function () {
        var type = get(this, "type").toString();
        throw new Error(
          "The result of a client-side filter (on " + type + ") is immutable."
        );
      },
    ...
    __exports__["default"] = RecordArray.extend({
      ...
      createRecord: function (hash) {
        ...
        Ember.assert(
          "You cannot add '" +
            type.typeKey +
            "' records to this polymorphic relationship.",
  ...
  define("ember-data/system/record_arrays/record_array", [
    ...
    __exports__["default"] = Ember.ArrayProxy.extend(Ember.Evented, {
      ...
      save: function () {
        ...
        var promise = Ember.RSVP.all(this.invoke("save"), promiseLabel).then(
          function (array) {
            return Ember.A(array);
          },
          null,
          "DS: RecordArray#save apply Ember.NativeArray"
        );
  ...
  define("ember-data/system/relationships", [
    ...
    "ember-data/system/relationships/ext",
    "exports",
  ], function (__dependency1__, __dependency2__, __dependency3__, __exports__) {
    "use strict";
    /**
  ...
  define("ember-data/system/relationships/belongs_to", [
    ...
    function belongsTo(type, options) {
      if (typeof type === "object") {
        ...
        Ember.assert(
          "The first argument to DS.belongsTo must be a string representing a model type key, e.g. use DS.belongsTo('person') to define a relation to the App.Person model",
          !!type && (typeof type === "string" || Model.detect(type))
        );
      }
  ...
  define("ember-data/system/relationships/ext", [
    "ember-data/system/relationship-meta",
    "ember-data/system/model",
    "ember-data/system/map",
    ...
    Model.reopenClass({
      ...
      _findInverseFor: function (name) {
        ...
        if (options.inverse) {
          ...
          inverse = Ember.get(inverseType, "relationshipsByName").get(
            inverseName
          );
          ...
          var filteredRelationships = filter.call(
            possibleRelationships,
            function (possibleRelationship) {
              var optionsForRelationship = inverseType.metaForProperty(
          ...
          Ember.assert(
            "You defined the '" +
              ...
              " multiple times. Look at http://emberjs.com/guides/models/defining-models/#toc_explicit-inverses for how to explicitly specify inverses",
          ...
          Ember.assert(
            "You defined the '" +
              ...
              " were found on " +
              inverseType +
              ". Look at http://emberjs.com/guides/models/defining-models/#toc_explicit-inverses for how to explicitly specify inverses",
        ...
        function findPossibleInverses(type, inverseType, relationshipsSoFar) {
          ...
          if (relationships) {
            possibleRelationships.push.apply(
              possibleRelationships,
              relationships
            );
          }
      ...
      relationships: Ember.computed(function () {
        ...
        this.eachComputedProperty(function (name, meta) {
          ...
          if (meta.isRelationship) {
            meta.key = name;
            var relationshipsForType = map.get(
              typeForRelationshipMeta(this.store, meta)
            );
  ...
  define("ember-data/system/relationships/relationship", [
    ...
    var Relationship = function (store, record, inverseKey, relationshipMeta) {
      ...
      this.inverseKeyForImplicit =
        this.store.modelFor(this.record.constructor).typeKey + this.key;
        ...
        if (!this.members.has(record)) {
          ...
          if (this.inverseKey) {
            ...
            if (!record._implicitRelationships[this.inverseKeyForImplicit]) {
              record._implicitRelationships[
                this.inverseKeyForImplicit
              ] = new Relationship(this.store, record, this.key, {
                options: {},
              });
            }
            record._implicitRelationships[this.inverseKeyForImplicit].addRecord(
              this.record
            );
          }
    ...
    var ManyRelationship = function (
      ...
      this.manyArray = store.recordArrayManager.createManyArray(
        this.belongsToType,
        Ember.A()
      );
    ...
    ManyRelationship.prototype.notifyRecordRelationshipAdded = function (
      record,
      idx
    ) {
      Ember.assert(
        "You cannot add '" +
          ...
          "' records to this relationship (only '" +
          this.belongsToType.typeKey +
          "' allowed)",
    ...
    ManyRelationship.prototype.notifyRecordRelationshipRemoved = function (
      record
    ) {
    ...
    ManyRelationship.prototype.reload = function () {
      ...
      if (this.link) {
        ...
        return this.store
          .scheduleFetchMany(this.manyArray.toArray())
          .then(function () {
    ...
    ManyRelationship.prototype.fetchLink = function () {
      var self = this;
      return this.store
        .findHasMany(this.record, this.link, this.relationshipMeta)
      ...
      if (this.isAsync) {
        ...
        Ember.assert(
          "You looked up the '" +
            this.key +
            "' relationship on a '" +
            this.record.constructor.typeKey +
            "' with id " +
            this.record.get("id") +
          ...
          this.manyArray.isEvery("isEmpty", false)
        );
    ...
    var BelongsToRelationship = function (
      store,
      record,
      inverseKey,
      relationshipMeta
    ...
    BelongsToRelationship.prototype._super$addRecord =
      Relationship.prototype.addRecord;
    BelongsToRelationship.prototype.addRecord = function (newRecord) {
      ...
      Ember.assert(
        "You can only add a '" + type.typeKey + "' record to this relationship",
    ...
    BelongsToRelationship.prototype.notifyRecordRelationshipAdded = function (
      newRecord
    ) {
      this.record.notifyBelongsToAdded(this.key, this);
    };

    BelongsToRelationship.prototype.notifyRecordRelationshipRemoved = function (
      record
    ) {
      this.record.notifyBelongsToRemoved(this.key, this);
    };

    BelongsToRelationship.prototype._super$removeRecordFromOwn =
      Relationship.prototype.removeRecordFromOwn;
    ...
    BelongsToRelationship.prototype.fetchLink = function () {
      var self = this;
      return this.store
        .findBelongsTo(this.record, this.link, this.relationshipMeta)
    ...
    BelongsToRelationship.prototype.getRecord = function () {
      if (this.isAsync) {
        ...
        Ember.assert(
          ...
          this.inverseRecord === null || !this.inverseRecord.get("isEmpty")
        );
  ...
  define("ember-data/system/store", [
    ...
    Store = Ember.Object.extend({
      ...
      init: function () {
        ...
        if (!RecordArrayManager) {
          RecordArrayManager = requireModule(
            "ember-data/system/record_array_manager"
          )["default"];
        }
        this.typeMaps = {};
      ...
      /**
          ...
          */
      serialize: function (record, options) {
        return this.serializerFor(record.constructor.typeKey).serialize(
          record,
          options
        );
      },
      ...
      defaultAdapter: Ember.computed("adapter", function () {
        ...
        if (typeof adapter === "string") {
          adapter =
            this.container.lookup("adapter:" + adapter) ||
            this.container.lookup("adapter:application") ||
            this.container.lookup("adapter:-rest");
        }
      ...
      find: function (type, id, preload) {
        ...
        Ember.assert(
          "You may not pass `" + id + "` as id to the store's find method",
          arguments.length === 1 || !Ember.isNone(id)
        );
      ...
      fetchRecord: function (record) {
        ...
        Ember.assert(
          "You tried to find a record but you have no adapter (for " +
            type +
            ")",
          adapter
        );
        Ember.assert(
          "You tried to find a record but your adapter (for " +
            type +
      ...
      scheduleFetch: function (record) {
        ...
        var resolver = Ember.RSVP.defer(
          "Fetching " + type + "with id: " + record.get("id")
        );
      ...
      _flushPendingFetchForType: function (recordResolverPairs, type) {
        ...
        function _fetchRecord(recordResolverPair) {
          recordResolverPair.resolver.resolve(
            store.fetchRecord(recordResolverPair.record)
          );
        }
        ...
        if (recordResolverPairs.length === 1) {
          ...
          forEach(groups, function (groupOfRecords) {
            ...
            if (ids.length > 1) {
              ...
              var pair = Ember.A(recordResolverPairs).findBy(
                "record",
                groupOfRecords[0]
              );
              _fetchRecord(pair);
      ...
      reloadRecord: function (record) {
        ...
        Ember.assert(
          "You tried to reload a record but you have no adapter (for " +
            type +
            ")",
          adapter
        );
        Ember.assert(
          "You tried to reload a record but your adapter does not implement `find`",
          adapter.find
        );
      ...
      findQuery: function (typeName, query) {
        var type = this.modelFor(typeName);
        var array = this.recordArrayManager.createAdapterPopulatedRecordArray(
          type,
          query
        );
        ...
        Ember.assert(
          "You tried to load a query but you have no adapter (for " +
            type +
            ")",
          adapter
        );
        Ember.assert(
          "You tried to load a query but your adapter does not implement `findQuery`",
          adapter.findQuery
        );
      ...
      fetchAll: function (type, array) {
        ...
        Ember.assert(
          "You tried to load all records but you have no adapter (for " +
            type +
            ")",
          adapter
        );
      ...
      flushPendingSave: function () {
        ...
        forEach(
          ...
          function (tuple) {
            ...
            if (
              get(record, "currentState.stateName") === "root.deleted.saved"
            ) {
      ...
      updateId: function (record, data) {
        ...
        Ember.assert(
          "An adapter cannot assign a new id to a record that already has an id. " +
            ...
            " had id: " +
            oldId +
            " and you tried to update it with " +
            id +
            ". This likely happened because your server returned data in response to a find or update that had a different id than the one you sent.",
          oldId === null || id === oldId
        );
      ...
      push: function (typeName, data, _partial) {
        ...
        Ember.assert(
          "Expected an object as `data` in a call to push for " +
            ...
            " , but was " +
            data,
          Ember.typeOf(data) === "object"
        );
        Ember.assert(
          "You must include an `id` for " +
            typeName +
            " in an object passed to `push`",
          data.id != null
        );
      ...
      buildRecord: function (type, id, data) {
        ...
        Ember.assert(
          "The id " +
            id +
            " has already been used with another record of type " +
            type.toString() +
            ".",
          !id || !idToRecord[id]
        );
      ...
      adapterFor: function (type) {
        ...
        if (container) {
          adapter =
            container.lookup("adapter:" + type.typeKey) ||
      ...
      serializerFor: function (type) {
        ...
        return serializerFor(
          this.container,
          type.typeKey,
          adapter && adapter.defaultSerializer
        );
      },
    ...
    function serializerFor(container, type, defaultSerializer) {
      return (
        container.lookup("serializer:" + type) ||
    ...
    function _find(adapter, store, type, id, record) {
      ...
      return promise.then(
        function (adapterPayload) {
          ...
          var payload = serializer.extract(
            store,
            type,
            adapterPayload,
            id,
    ...
    function _findMany(adapter, store, type, ids, records) {
      ...
      if (promise === undefined) {
        throw new Error(
          "adapter.findMany returned undefined, this was very likely a mistake"
        );
      }
      ...
      return promise.then(
        function (adapterPayload) {
          ...
          Ember.assert(
            "The response from a findMany must be an Array, not " +
              Ember.inspect(payload),
            Ember.typeOf(payload) === "array"
          );
    ...
    function _findHasMany(adapter, store, record, link, relationship) {
      ...
      var label =
        "DS: Handle Adapter#findHasMany of " +
        record +
        " : " +
        relationship.type;
      ...
      return promise.then(
        function (adapterPayload) {
          ...
          Ember.assert(
            "The response from a findHasMany must be an Array, not " +
              Ember.inspect(payload),
            Ember.typeOf(payload) === "array"
          );
        ...
        null,
        "DS: Extract payload of " + record + " : hasMany " + relationship.type
      );
    }
    ...
    function _findBelongsTo(adapter, store, record, link, relationship) {
      ...
      var serializer = serializerForAdapter(adapter, relationship.type);
      var label =
        "DS: Handle Adapter#findBelongsTo of " +
        record +
        " : " +
        relationship.type;
      ...
      return promise.then(
        ...
        null,
        "DS: Extract payload of " + record + " : " + relationship.type
      );
    }
    ...
    function _findAll(adapter, store, type, sinceToken) {
      ...
      return promise.then(
        function (adapterPayload) {
          ...
          Ember.assert(
            "The response from a findAll must be an Array, not " +
              Ember.inspect(payload),
            Ember.typeOf(payload) === "array"
          );
        ...
        null,
        "DS: Extract payload of findAll " + type
      );
    }
    ...
    function _findQuery(adapter, store, type, query, recordArray) {
      ...
      return promise.then(
        function (adapterPayload) {
          ...
          Ember.assert(
            "The response from a findQuery must be an Array, not " +
              Ember.inspect(payload),
            Ember.typeOf(payload) === "array"
          );
    ...
    function _commit(adapter, store, operation, record) {
      ...
      Ember.assert(
        "Your adapter's '" +
          operation +
          "' method must return a value, but it returned `undefined",
        promise !== undefined
      );
  ...
  define("ember-inflector/ext/string", ["../system/string"], function (
    __dependency1__
  ) {
    "use strict";
    var pluralize = __dependency1__.pluralize;
  ...
  define("ember-inflector/helpers", ["./system/string"], function (
    __dependency1__
  ) {
    "use strict";
    var singularize = __dependency1__.singularize;
  ...
  define("ember-inflector/system/inflections", ["exports"], function (
    __exports__
  ) {
    "use strict";
    __exports__["default"] = {
  ...
  define("ember-inflector/system/inflector", ["exports"], function (
    __exports__
  ) {
    "use strict";
    var BLANK_REGEX = /^\s*$/;
    ...
    Inflector.prototype = {
      ...
      enableCache: function () {
        ...
        this.pluralize = function (word) {
          this._cacheUsed = true;
          return (
            this._pCache[word] || (this._pCache[word] = this._pluralize(word))
          );
        };
      },
      ...
      inflect: function (word, typeRules, irregular) {
        ...
        wordSplit =
          LAST_WORD_DASHED_REGEX.exec(word) ||
          LAST_WORD_CAMELIZED_REGEX.exec(word);
        if (wordSplit) {
        ...
        isIrregular =
          irregular && (irregular[lowercase] || irregular[lastWord]);
  ...
  define("ember-inflector/system/string", ["./inflector", "exports"], function (
    __dependency1__,
    __exports__
  ) {
    "use strict";
